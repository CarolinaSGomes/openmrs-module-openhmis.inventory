...
public class PrivilegeWebConstants extends PrivilegeConstants {
	...
	public static final String OPERATION_TYPES_PAGE_PRIVILEGES = MANAGE_OPERATION_TYPES;
	public static final String OPERATIONS_PAGE_PRIVILEGES = VIEW_OPERATIONS;
	public static final String ITEM_CONCEPT_SUGGESTION_PAGE_PRIVILEGES = VIEW_ITEM_CONCEPT_SUGGESTION_PAGE;
